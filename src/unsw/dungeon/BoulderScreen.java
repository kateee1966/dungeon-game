...
public class BoulderScreen {
    ...
    public BoulderScreen(Stage stage) throws IOException {
    	this.stage = stage;
    	title ="Dungeon";
        ...
        Label goal = new Label("· Goal: Collect All Treasures And Covered All Flour Switches!");
